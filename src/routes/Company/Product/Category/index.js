...
import CategoryModal from "components/modal/Products/Category"
        ...
        return (
            <>
                <div className="gx-module-box-header row">
                    <AppModuleHeader placeholder="Search Category"
                ...
                <CategoryModal open={modal} onClose={this.onClose}></CategoryModal>
            </>
        )
    }
}
