...
import ProductFamilyModal from "components/modal/Products/ProductFamily"
        ...
        return (
            <>
                <div className="gx-module-box-header row">
                    <AppModuleHeader placeholder="Search Product Family"
                ...
                <ProductFamilyModal open={modal} onClose={this.onClose}></ProductFamilyModal>
            </>
        )
    }
}
