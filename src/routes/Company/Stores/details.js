...
import { SmileTwoTone, HeartTwoTone, DeleteOutlined, LikeOutlined, ApartmentOutlined, EditOutlined,DeleteRowOutlined } from '@ant-design/icons';
...
function Details() {
    ...
    return (
        <>
            <PageHeaderWithBackNoSearch title={product.product_name} subtitle="Product" islist={true} isadd={false} />
                ...
                <Col flex={2}>
                    <Card
                        ...
                        actions={[
                            ...
                            <span>
                                <DeleteRowOutlined key="delete"  onClick={() => history.push(`${restVar}/edit/${id}`)} style={{
                                    fontSize: '30px'
                                }} />
                            </span>,
                        ]}
