...
function Details() {
    ...
    useEffect(() => {
        Get_User().then(result => {
            console.log("Mani",result.res.data)
    ...
    return (
        ...
        <>
             <PageHeaderWithBackNoSearch value={Users.user_name} subtitle="User" islist={true} isadd={false} />
            <Row className="gx-main-content-wrapper" style={{margin: "0px"}}>
                <Col flex={2}>
                    <Card
                        ...
                        //     <img
                        //         alt=""
                        //         src={product.profile_imageSearch Product_url=== "image.png" ? '': product.profile_image_url}
                        //     />
                        // }
                        actions={[
                            <span>
                    ...
                    >
                        ...
                        {/* <Meta title={Users.user_name} description={Users.first_name} /> */}
                ...
                <Col flex={3}>
                    <Row>
                        <Col span={12}>
                            <Statistic title= "UserName" name={Users.first_name} />
                        </Col>
                    </Row>
