...
import { AddCountry, GetCountries } from 'api/Shared/Master/CountryController'
...
function CountrySetting() {
    ...
    return (
        <div className="gx-module-box-content">
            ...
            {view ? (<CountrySettingView editableData={editableData}  country={searchItem}/>) : <CountrySettingForm  addData={addData} editableDataToForm={editData} />}
        </div>
    )
};
