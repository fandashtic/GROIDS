...
const  View = ({editableData,manufactures,deletedData}) => {
    ...
    const deleteFile = () => {
        setshowDelete(false)
        deletedData(dataDelete.manufacture_id)
    ...
    return (
        <>
            {tableView ? <Table className="gx-table-responsive" columns={columns} dataSource={manufactures} pagination={{ pageSize: Pagination }}
                scroll={{ y: 240 }} /> : (
                    <>
                        <div className="gx-module-box-topbar">
                            <Row justify="space-between">
                                <Col>
                                    <h2>Manufactures Data</h2>
                                </Col>
                                <Col>
