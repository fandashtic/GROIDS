...
import { AddCity, GetCities,CityLookUp } from 'api/Shared/Master/CityController'
...
function CitySetting() {
    ...
    return (
        <div className="gx-module-box-content">
            ...
            {view ? (<CitySettingView editableData={editableData}  City={searchItem}/>) : <CitySettingForm  addData={addData} editableDataToForm={editData} cityLookUpData ={cityLookUpData}/>}
        </div>
    )
};
