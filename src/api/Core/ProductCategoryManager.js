...
const GetProductCategoryHierarchyData = async (product_category, callback) => {
    ...
    GetAllManufactureData(active_filter, async (manufactures) => {
        ...
        await GetAllBrandDatas(active_filter, async (brands) => {
            let _b = GetLookUpData(brands, 'brand_id', 'brand_name', 'manufacture_id',_lookup.brand_id);
...
export { ProductCategoryLookUp, IsProductCategoryValid, AddProductCategory, UpdateProductCategory, DeleteProductCategory, GetProductCategory, GetAllProductCategories };