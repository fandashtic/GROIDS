import { GetAllUsers, IsUserValid, AddUser, UpdateUser, DeleteUser, ChangePassword } from 'api/Core/UserManager'
...
export { IsUserValidAPI, AddUserAPI, UpdateUserAPI, DeleteUserAPI, GetUsersAPI, ChangePasswordAPI };