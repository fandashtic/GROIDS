import { GetAllStores, AddStore, UpdateStore, DeleteStore, StoreLookUp, GetStore } from 'api/Core/StoreManager';
...
export { AddStoreAPI, UpdateStoreAPI, DeleteStoreAPI, GetStoresAPI, GetStoreAPI, StoreLookUpAPI };