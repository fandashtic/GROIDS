...
const Portfolio = () => {
  return (
    <Widget>
      <h2 className="h4 gx-mb-3">Top 3 Store's</h2>
      <Row>
        <Col lg={12} md={12} sm={12} xs={24}>
          ...
          <p className="gx-text-grey">Overall Sales</p>
        </Col>

        <Col lg={12} md={12} sm={12} xs={24}>
          <div className="gx-site-dash">
            <h5 className="gx-mb-3">Stores</h5>
            <ul className="gx-line-indicator gx-fs-sm gx-pb-1 gx-pb-sm-0">
              <li>
                <LineIndicator width="78%" title="ABC Super Market" title2="8.74" color="primary" value="78%"/>
              </li>
              <li>
                <LineIndicator width="38%" title="Rich Shopiee" title2="1.23" color="pink" value="48%"/>
              </li>
              <li>
                <LineIndicator width="24%" title="Local Market" title2="0.71" color="orange" value="34%"/>
              </li>
            </ul>
